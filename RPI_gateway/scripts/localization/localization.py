...
def fingerprinting():
    ...
    if(previous_room != current_room):
        ...
        bashCommand="sudo convert /etc/openhab2/html/localization/current.png -pointsize 18 -fill #00CCFF -annotate +600+50 " +  current_room+ " /etc/openhab2/html/localization/current.png"
